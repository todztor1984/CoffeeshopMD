...
Public Class frm_customer
    ...
    Public Sub load_customer()
        ...
        sql = "select username, name, nickname from customer"
    ...
    Public Sub search_customer()
        ...
        sql = "select username, name, nickname from customer where username like '%" & txt_search.Text & "%' or password like '%" & txt_search.Text & "%' or name like '%" & txt_search.Text & "%' or nickname like '%" & txt_search.Text & "%' or address like '%" & txt_search.Text & "%' or tel like '%" & txt_search.Text & "%' "
        DA = New SqlClient.SqlDataAdapter(sql, cn)
        DS = New DataSet
        DA.Fill(DS, "table")
    ...
    Private Sub btn_add_save_Click(sender As Object, e As EventArgs) Handles btn_add_save.Click
        If confirm("ยืนยันการเพิ่มข้อมูล ") = vbNo Then
            Return
        End If
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        If confirm("ยืนยันการลบข้อมูลหรือไม่ ?") = vbNo Then
            Return
        End If
